...
```
[1] "Matrix (column-wise fill):"
     [,1] [,2] [,3]
[1,]    1    4    7
[2,]    2    5    8
[3,]    3    6    9
[1] "Matrix (row-wise fill):"
     [,1] [,2] [,3]
[1,]    1    2    3
[2,]    4    5    6
[3,]    7    8    9
[1] "Matrix with data recycling:"
     [,1] [,2] [,3]
[1,]    1    3    2
[2,]    2    1    3
[1] "Sales Data Matrix:"
...
Q2   80  110   130
[1] "matrix" "array"
[1] "Coerced Matrix (numeric and character becomes character):"
     [,1] [,2]
[1,] "1"  "A"
[2,] "2"  "B"
[1] "matrix" "array"
...
[1] "Element at R2, C3:"
[1] 6
[1] "All elements in R1:"
C1 C2 C3
 1  2  3
[1] "All elements in C2:"
R1  2
R2  5
R3  8
R4 11
[1] "Elements in R1 and R3:"
   C1 C2 C3
R1  1  2  3
R3  7  8  9
[1] "Elements in C1 and C3:"
   C1 C3
R1  1  3
R2  4  6
R3  7  9
R4 10 12
[1] "Sub-matrix (R2, R3 and C1, C2):"
   C1 C2
R2  4  5
R3  7  8
[1] "Rows where C1 value > 5:"
   C1 C2 C3
R3  7  8  9
R4 10 11 12
[1] "Elements > 7 (vector):"
[1]  8  9 10 11 12
[1] "Element at 'R4', 'C1' (using names):"
[1] 10
[1] "Columns 'C1' and 'C3' (using names):"
   C1 C3
R1  1  3
R2  4  6
R3  7  9
...
[1] 2
[1] "Dimensions of A (rows, columns):"
[1] 2 2
[1] "Row-bound matrix (A and C):"
     [,1] [,2]
[1,]    1    2
[2,]    3    4
[3,]    9   10
[1] "Column-bound matrix (A and D):"
     [,1] [,2] [,3]
[1,]    1    2   11
[2,]    3    4   12
[1] "Invertible Matrix:"
...
[1,]    4    7
[2,]    2    6
[1] "Inverse of Invertible Matrix:"
          [,1]      [,2]
[1,]  0.4285714 -0.5000000
[2,] -0.1428571  0.2857143
[1] "Product of Matrix and its Inverse:"
              [,1]          [,2]
...
[1] "Element at [1, 2, 3]:"
[1] 15
[1] "Second layer of the array:"
     [,1] [,2] [,3]
[1,]    7    9   11
[2,]    8   10   12
[1] "First row across all layers:"
    [,1] [,2] [,3] [,4]
[1,]   1    3    5    7
[2,]   9   11   13   15
[3,]   17   19   21   23
[1] "Product Sales Array:"
, , Q1
...
[1] "Sales for Product B in Q2 (all regions):"
  North South
     45    60
```
